                  ...
                  $msg='<div class="alert alert-danger" role="alert"><i class="fa fa-bell-o" aria-hidden="true"></i> The passwords are not identicals</div>';
                   ...
                   if(isset($_FILES['image'])){
                    ...
                    $image_size = $image['size'];
                                ...
                                if($image_size <= 3200000){
                                  ...
                                  $image_db ='images/avatar/'.$new_name;
                                    if(move_uploaded_file($image_tmp, $image_dir)){
                                      ...
                                      $update = "UPDATE  registrars SET userpass='$Password', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                       ...
                       $sql=mysqli_query($conn,"UPDATE  registrars SET userpass='$Password', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
                           if (isset($sql)) {
                              $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                                echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                              }
              ...
              if(isset($_FILES['image'])){
                 ...
                 $image_size = $image['size'];
                    ...
                    $editname = str_split($editname, 3);
                          ...
                          if($image_size <= 3200000){
                            ...
                            $image_db ='images/avatar/'.$new_name;
                                if(move_uploaded_file($image_tmp, $image_dir)){
                                   ...
                                   $facebook=htmlspecialchars($_POST["facebook"]);
                                   $about=strip_tags($_POST["about"]);
                                   $update = "UPDATE  registrars SET  gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                                   $sql=mysqli_query($conn,$update);
                                     if (isset($sql)) {
                                        $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                                        echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                     ...
                     $sql=mysqli_query($conn,"UPDATE  registrars SET gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
                     if (isset($sql)) {
                       $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                       echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                      }
           ...
           if($_POST['pass'] !='' OR $_POST['con_pass']!=''){
              if($_POST['pass'] !=  $_POST['con_pass']){
                ...
                $image_size = $image['size'];
                         ...
                         if($image_error === 0){
                            if($image_size <= 3200000){
                              ...
                              if(move_uploaded_file($image_tmp, $image_dir)){
                                ...
                                $facebook=htmlspecialchars($_POST["facebook"]);
                                $about=strip_tags($_POST["about"]);
                                $update = "UPDATE  registrars SET username='$editeuser', userpass='$Password', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                                $sql=mysqli_query($conn,$update);
                                if (isset($sql)) {
                                  $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                                  echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                  ...
                  $facebook=htmlspecialchars($_POST["facebook"]);
                  $about=strip_tags($_POST["about"]);
                  $sel="UPDATE  registrars SET username='$editeuser', userpass='$Password', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'";
                  ...
                  if($image_error === 0){
                    if($image_size <= 3200000){
                      ...
                      if(move_uploaded_file($image_tmp, $image_dir)){
                        ...
                        $facebook=htmlspecialchars($_POST["facebook"]);
                        $about=strip_tags($_POST["about"]);
                        $update = "UPDATE  registrars SET username='$editeuser', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                        $sql=mysqli_query($conn,$update);
                          if (isset($sql)) {
                            $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                            echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
...
elseif ($editeuser ==$user['username'] AND $editemail !=$user['useremail']) {
   ...
   if(mysqli_num_rows($sql)>0){
    ...
    if($_POST['pass'] !='' OR $_POST['con_pass']!=''){
                    ...
                    if($image_error === 0){
                      if($image_size <= 3200000){
                       ...
                       if(move_uploaded_file($image_tmp, $image_dir)){
                          ...
                          $facebook=htmlspecialchars($_POST["facebook"]);
                          $about=strip_tags($_POST["about"]);
                          $update = "UPDATE  registrars SET useremail ='$editemail', userpass='$Password', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                          $sql=mysqli_query($conn,$update);
                         if (isset($sql)) {
                           $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                           echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
              ...
              $sql=mysqli_query($conn,"UPDATE  registrars SET useremail ='$editemail', userpass='$Password', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
               if (isset($sql)) {
                 $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                  echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                 }
    ...
    if(isset($_FILES['image'])){
      ...
      $image_size = $image['size'];
          ...
          if(in_array($img_exe,$allowd)){
             if($image_error === 0){
               if($image_size <= 3200000){
                  ...
                  if(move_uploaded_file($image_tmp, $image_dir)){
                    ...
                    $facebook=htmlspecialchars($_POST["facebook"]);
                    $about=strip_tags($_POST["about"]);
                    $update = "UPDATE  registrars SET useremail ='$editemail', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                    $sql=mysqli_query($conn,$update);
                    if (isset($sql)) {
                       $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                       echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
           ...
           $sql=mysqli_query($conn,"UPDATE  registrars SET useremail ='$editemail', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
            if (isset($sql)) {
             $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
             echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                              }
...
//-------------
        ...
        $image_size = $image['size'];
              ...
              if($image_error === 0){
                if($image_size <= 3200000){
                  ...
                  if(move_uploaded_file($image_tmp, $image_dir)){
                      ...
                      $facebook=htmlspecialchars($_POST["facebook"]);
                      $about=strip_tags($_POST["about"]);
                      $update = "UPDATE  registrars SET username='$editeuser', useremail ='$editemail', userpass='$Password', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                      $sql=mysqli_query($conn,$update);
                      if (isset($sql)) {
                         $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                          echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
            ...
            $sql=mysqli_query($conn,"UPDATE  registrars SET username='$editeuser', useremail ='$editemail', userpass='$Password', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
             if (isset($sql)) {
                $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
                        }
  ...
  if(isset($_FILES['image'])){
   ...
   $image_size = $image['size'];
        ...
        if($image_error === 0){
          if($image_size <= 3200000){
            ...
            if(move_uploaded_file($image_tmp, $image_dir)){
                ...
                $facebook=htmlspecialchars($_POST["facebook"]);
                $about=strip_tags($_POST["about"]);
                $update = "UPDATE  registrars SET username='$editeuser', useremail ='$editemail', gender='$gender', useercomment='$about',avatar='$image_db',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE   user_id= '$id'";
                $sql=mysqli_query($conn,$update);
              if (isset($sql)) {
                 $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
                 echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
    ...
    $sql=mysqli_query($conn,"UPDATE  registrars SET username='$editeuser', useremail ='$editemail', gender='$gender', useercomment='$about',linkedin='$linkedin', github='$github', facebook='$facebook' WHERE user_id= '$id'");
     if (isset($sql)) {
       $msg='<div class="alert alert-success" role="alert"> <i class="fa fa-check" aria-hidden="true"></i> eddited  successfully.</div>';
       echo '<meta http-equiv="refresh" content="3 ;profile.php?user='.$id.'" />';
      }
