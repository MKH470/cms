      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="margin-left: 60px;">
          ...
          <ul class="nav navbar-nav navbar-left">
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img  src="<?php echo $_SESSION['avatar']?>"  width="40px" lang="30px" class="img-circle" style="margin-top: -15px;margin-bottom:-15px;" /> <span class="caret"></span></a>
              <ul class="dropdown-menu" style=" text-align: left;">
                <li><a href="profile.php?user=<?php echo $_SESSION['id'];?>"><i class="fa fa-user-circle-o" aria-hidden="true"></i> Profile</a></li>
                <?php
                if ($_SESSION['role']=='writer' OR $_SESSION['role']=='admin') {
